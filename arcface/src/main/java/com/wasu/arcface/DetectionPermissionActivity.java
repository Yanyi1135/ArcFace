...
public class DetectionPermissionActivity extends Activity {
        ...
        if (mRequestPermission.isEmpty()) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    DetectionPermissionActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            mProgressDialog.cancel();
                            Intent intent = new Intent(DetectionPermissionActivity.this, DetecterActivity.class);
                            // TODO: camera id
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    DetectionPermissionActivity.this.finish();
                }
            }, 3000);
        }
    }
